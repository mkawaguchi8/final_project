...
def generate_fortune():
    ...
    outcomes = {
        ...
        "2項目": [
            "【健康】エネルギーや活力に満ち溢れています",
            "北と東の間がよいでしょう。旅の間に、地元の人と話してみるのも吉"
            "【健康】健康な体と心を大切にすれば大丈夫です",
            "予定が変わるかもしれません",
            "【健康】普段の生活での注意や予防策をしっかりと行いましょう",
            "新たな発見や気づきがあなたを豊かにするでしょう",
            "【健康】健康な体と心を大切にし、積極的に自己管理に努めましょう",
            "どこへ行っても良い気分転換になるでしょう",
            "【健康】ストレスや疲労に注意し、十分な睡眠をとることも重要です",
            "弁慶のような、旅のお供を探すと吉",
        ],
        # "【旅行】": [
        #     "北と東の間がよいでしょう。旅の間に、地元の人と話してみるのも吉",
    ...
    outcome_1 = outcomes["1項目"][key]
    outcome_2 = outcomes["2項目"][key]
